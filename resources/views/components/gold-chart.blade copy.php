    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if (isset($charts) && count($charts) > 0)
                ...
                const monthNamesFull = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus',
            ...
            @else
                ...
                const fullDates = ['11 Agustus', '12 Agustus', '13 Agustus', '14 Agustus', '15 Agustus',
                    '16 Agustus', '17 Agustus'
                ];
