        ...
        <nav class="bg-primary shadow-lg rounded-md border border-secondary h-14 sm:h-16 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-full">
                ...
                <div class="hidden lg:flex items-center space-x-6 xl:space-x-8">
                    ...
                    <a href="{{ route('home') }}#toko-kami" class="text-white font-bold hover:text-secondary transition-colors duration-200 text-md xl:text-lg">Lokasi Kami</a>
                ...
                <!-- Desktop CTA Button -->
                <div class="">
                    <a href="{{ route('contact') }}" target="_blank" class="bg-secondary hover:bg-yellow-300 text-black px-4 xl:px-6 py-2 font-semibold transition-colors duration-200 text-center text-md xl:text-xl">
                        Hubungi Kami
                    </a>
                </div>
            </div>
